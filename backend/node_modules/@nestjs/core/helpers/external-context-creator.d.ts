...
import { ExternalHandlerMetadata } from '@nestjs/core/helpers/interfaces/external-handler-metadata.interface';
...
export declare class ExternalContextCreator {
    ...
    exchangeKeysForValues<TMetadata = any>(keys: string[], metadata: TMetadata, moduleContext: string, paramsFactory: ParamsFactory, contextId?: ContextId, inquirerId?: string, contextFactory?: (args: unknown[]) => import("@nestjs/core/helpers/execution-context-host").ExecutionContextHost): ParamProperties[];
