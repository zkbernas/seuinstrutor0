...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const baseMenuItems = [
    {
      to: isStudent ? '/app/home' : '/app/dashboard',
      icon: isStudent ? Home : LayoutDashboard,
      label: isStudent ? 'Home' : 'Dashboard',
      show: true,
    },
    {
      to: '/app/instructors',
      icon: Users,
      label: 'Instrutores',
      show: !isStudent, // Students não veem esta página (usam o feed)
    },
    {
      to: '/app/students',
      icon: GraduationCap,
      label: 'Alunos',
      show: !isStudent, // Students não veem esta página
    },
    {
      to: '/app/classes',
      icon: GraduationCap,
    ...
    },
    {
      ...
      icon: CreditCard,
      label: 'Planos',
      show: !isStudent, // Students não veem planos (por enquanto)
    },
    {
      to: '/app/settings',
      icon: Settings,
