...
import { Users, GraduationCap, DollarSign, TrendingUp, ArrowRight, Sparkles, Shield } from 'lucide-react';
...
export function DashboardPage() {
  ...
  // Nota: A proteção contra STUDENT é feita pelo DashboardRoute wrapper
  // Este componente só é renderizado para ADMIN, OPERATOR ou INSTRUCTOR
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      {/* Admin Access - Só aparece para ADMIN */}
      {isAdmin && (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Gerenciar usuários, planos e relatórios
                </p>
              </div>
            </div>
            <button
              onClick={() => navigate('/app/admin')}
              className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white hover:bg-gray-800 rounded-lg transition-colors font-semibold text-sm"
            >
              Acessar
