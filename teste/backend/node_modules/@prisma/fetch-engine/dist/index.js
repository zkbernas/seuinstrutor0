...
__export(index_exports, {
  ...
  download: () => import_chunk_CF4OQDAJ.download,
  engineEnvVarMap: () => import_chunk_QFA3XBMW.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_QFA3XBMW.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_CF4OQDAJ.getBinaryName,
  getCacheDir: () => import_chunk_LONQL55G.getCacheDir,
  getProxyAgent: () => import_chunk_VAPNG6TS.getProxyAgent,
  getVersion: () => import_chunk_CF4OQDAJ.getVersion,
  maybeCopyToTmp: () => import_chunk_CF4OQDAJ.maybeCopyToTmp,
  overwriteFile: () => import_chunk_LONQL55G.overwriteFile,
  plusX: () => import_chunk_CF4OQDAJ.plusX,
  vercelPkgPathRegex: () => import_chunk_CF4OQDAJ.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_CF4OQDAJ = require("./chunk-CF4OQDAJ.js");
